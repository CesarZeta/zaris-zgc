...
| 006 | `sql/006_ventas_comprobantes.sql` | ✅ 2026-07-04 | ⬜ pendiente | Fase 3: puntos_venta, tipos_comprobante (seed 12 tipos), numeracion, comprobantes + items + alicuotas (patrón TABLAIVA→AlicIva) + vencimientos, recibos + medios, imputaciones, arca_config + arca_tokens. Extiende CHECK de stock_movimientos.tipo (devolucion/remito/anulacion). RLS enable en las 12 tablas nuevas. |
