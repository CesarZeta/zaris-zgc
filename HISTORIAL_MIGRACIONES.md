...
| 007 | `sql/007_compras_proveedores.sql` | ✅ 2026-07-05 | ⬜ pendiente | Fase 4: proveedores (rol BUE), articulo_proveedores (comparativo), tipos_comprobante_compra (seed 10), compras + compra_items + compra_vencimientos, numeracion_compras (OP), ordenes_pago + medios, imputaciones_compras, articulos.proveedor_habitual_id. Sin cambios al CHECK del kardex (reusa compra/remito/devolucion/anulacion). RLS enable en las 10 tablas nuevas. Correr en Supabase por SQL Editor antes del deploy. |
