...
| 005 | `sql/005_rls_supabase.sql` | ✅ 2026-07-04 | ⏳ pendiente | Hardening deploy: RLS deny-all en todo public + revoke a anon/authenticated (PostgREST cerrado; el backend, como dueño, bypassa). Idempotente; en local no hace nada visible. |
